...
# TODO: переписать класс Кнопки используя готовый class Text и добавив биндинг событий
class Button:  # основная кнопка
    def __init__(self, image_names=[], path=os.path.join(BASE_DIR, 'Images', 'Buttons'), pos=(0, 0), function=None,
                 text='Simple Button'):
        self.images = {"normal": load_image(image_names[0], path=path, alpha_channel=True),
